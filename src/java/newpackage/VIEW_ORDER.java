...
out.println("<body style='background-image:url(https://lordnking.com/wp-content/uploads/2022/03/why-interior-design-and-architecture-matters-for-business.jpeg)'>");
   out.println("<br>");
       ...
       out.println("<h1 class='heading' style='margin-left:70px;'>ORDERS</h1>");
            ...
            out.println("<th>Budget Range</th>");
            out.println("<th>Address</th>");
            out.println("<th>House Area</th>");
            ...
            db.rst = db.stmt.executeQuery("select * from orders");
            int count = 1;
            ...
            while(db.rst.next()){
                ...
                out.println("<th> "+ db.rst.getString(1) +" </th>");
                 ...
                 out.println("<th> "+ db.rst.getString(7) +" </th>");
                  out.println("<th> "+ db.rst.getString(8) +" </th>");
                   out.println("<th> "+ db.rst.getString(9) +" </th>");
                out.println("</tr>");
                count++;
            }
