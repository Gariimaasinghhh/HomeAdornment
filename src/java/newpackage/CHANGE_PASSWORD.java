...
out.println("<body style='background-image:url(https://lordnking.com/wp-content/uploads/2022/03/why-interior-design-and-architecture-matters-for-business.jpeg)'>");
   out.println("<br>");
       ...
       out.println("<h1 class='heading' style='margin-left:70px;'>CHANGE YOUR PASSWORD</h1>");
...
out.println("<form method='post' action='passwordConf' >");
                     
             out.println("<input type='text' name='email' placeholder='Enter Your Email' id='email' style='height:35px;font-size:16pt;margin-left:290px;width:53%' >");
            out.println("<br>");
            out.println("<br><input type='text' name='newpass' placeholder='Enter Your Password'  style='height:35px;font-size:16pt;margin-left:290px;width:53%' >");
            out.println("<br>");
            out.println("<br><input type='text' name='confirmpass'  placeholder='Confirm Your Password' style='height:35px;font-size:16pt;margin-left:290px;width:53%' >");
             out.println("<br>");
             out.println("<br><br><br><input type='submit' class='btn btn-lg shadow-lg' style='margin-left:520px;color:black;font-weight:bold;height:40px;font-size:17px;background-color:#FF8D29;opaciy:1 !important;'>");
