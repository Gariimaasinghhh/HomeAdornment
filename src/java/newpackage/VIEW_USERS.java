...
out.println("<body style='background-image:url(https://lordnking.com/wp-content/uploads/2022/03/why-interior-design-and-architecture-matters-for-business.jpeg)'>");
   out.println("<br>");
       ...
       out.println("<h1 class='heading' style='margin-left:70px;'>USERS</h1>");
            ...
            out.println("<th colspan='2'>Operation</th>");
            out.println("</tr>");
            ...
            db.rst = db.stmt.executeQuery("select * from registration where utype='user'");
            int count = 1;
            ...
            while(db.rst.next()){
                ...
                out.println("<th> "+ db.rst.getString(4) +" </th>");
                out.println("<th> "+ db.rst.getString(5) +" </th>");
                out.println("<th> "+ db.rst.getString(6) +" </th>");
                out.println("<th> "+ db.rst.getString(7) +" </th>");
                out.println("<th> <a href='editConf?email="+db.rst.getString(2)+"' style='text-decoration:none;color:green;'>Edit </a></th>");
                out.println("<th> <a href='deleteUser?email="+db.rst.getString(2)+"' style='text-decoration:none;color:red;'>Delete </a></th>");
                out.println("</tr>");
                count++;
            }
