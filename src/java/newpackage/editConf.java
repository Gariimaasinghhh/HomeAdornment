...
out.println("<a style='color:#FF8D29;font-size:26px;' href='home'>HOME ADORNMENT <br>WEB PORTAL</a>");
...
out.println("<nav style='height:88px;text-align:center;'>");
 out.println(" <ul>");
    ...
    out.println(" <li><a href='VIEW_ORDERS'>View<br> Orders</a></li>");
...
out.println("<body style='background-image:url(https://lordnking.com/wp-content/uploads/2022/03/why-interior-design-and-architecture-matters-for-business.jpeg)'>");
   out.println("<br>");
       ...
       out.println("<h1 class='heading' style='margin-left:70px;'>EDIT THE DATA</h1>");
           
            out.println("<br>"); out.println("<br>"); out.println("<br>"); out.println("<br>"); out.println("<br>");
            
        out.println("<div class='form-container container mx-auto inputBox'>");
out.println("<section>");
...
String u_email = req.getParameter("email");
            ...
            db.rst = db.stmt.executeQuery("select * from registration where email='"+u_email+"'");
            
            if(db.rst.next()){
                String name = db.rst.getString(1);
            String email = db.rst.getString(2);
           
                     String utype= db.rst.getString(7);
                     
                
                
                out.println("<div style='margin:30px auto;width:60%;'>");
                out.println("<form action='update' method='get' style='margin-left:20px;width:100%;text-align:center;'>");
                out.println("<table style='width:100%' cellpadding='20'>");
                out.println("<input type='hidden' readonly name='email' value='"+email+"'>");
                
                
                out.println("<tr>");
                out.println("<th style='color:white;font-size:16pt;'>User Name</th>");
                out.println("<th><input type='text' readonly name='name' value='"+name+"' style='width:60%;height:40px;font-size:14pt;border:none;border-bottom:2px solid blue;text-align:center;'></th>");
                out.println("</tr>");
             
                
                out.println("<tr>");
                out.println("<th style='color:white;font-size:16pt;'>User Type</th>");
                out.println("<th><input type='text' name='utype' value='"+utype+"' style='width:60%;height:40px;font-size:14pt;border:none;border-bottom:2px solid blue;text-align:center;'></th>");
                out.println("</tr>");
                
                
                out.println("<tr>");
                 out.println("<th colspan='2'><input class='btn btn-success btn-lg shadow-lg' type='submit' value='Update Data' style='text-align:center;font-size:16pt;color:white;background-color:green;border:1px solid #8e44ad;padding:8px 12px;border-radius:6px;cursor:pointer;margin:5px 30px'></th>");
                out.println("</tr>");
                ...
                resp.sendRedirect("showAll?Email was Incorrect");
            }
...
out.println("</html>");
              ...
              Logger.getLogger(editConf.class.getName()).log(Level.SEVERE, null, ex);
          }
