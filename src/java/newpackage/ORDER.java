...
out.println("<h1 class='heading' style='margin-left:70px;'>ORDER NOW!</h1>");

out.println("<section class='home container-fluid p-0'>");
out.println("<div class='row hero'>");
 out.println(" <div >");
    out.println("<h1><br> <form style='font-size:19px;margin-left:460px;background-color:black;opacity:0.8;' action='orderConf' method='post' class='inputBox container px-4 py-3' onsubmit='return validate()'>");
            ...
            out.println("<input style='height:40px;font-size:17px;' type='text' class='form-control' required name='name' placeholder='Enter Your Name' id='name'>");
             out.println("<br><input style='height:40px;font-size:17px;' type='text' class='form-control' required name='contact' placeholder='Enter Your Contact' id='contact'>");
            ...
            out.println("<section>");
            out.println("<div class='form-group'>");
            out.println("<br><select style='height:40px;font-size:17px;' name='category' class='form-control' id='category'>");
              out.println("<option disabled selected>Select A Category </option>");
            out.println("<option value='Kitchen ' > Kitchen </option>");
            out.println("<option value='Hall' > Hall </option>");
            out.println("<option value='Bedroom' > Bedroom </option>");
            out.println("<option value='Dining'> Dining </option>");
            out.println("<option value='Bathroom '> Bathroom </option>");
            out.println("</select>");
       
            out.println("<br><select style='height:40px;font-size:17px;' name='option' class='form-control' id='option'>");
              out.println("<option disabled selected>Select A Option</option>");
            out.println("<option value='Painting/Renovation' > Painting/Renovation</option>");
            out.println("<option value=' Furniture '> Furniture </option>");
            out.println("<option value='Decor'> Decor</option>");
            out.println("</select>");
            
            out.println("<br><select style='height:40px;font-size:17px;' name='designer' class='form-control' id='designer'>");
              out.println("<option disabled selected>Select A designer </option>");
            out.println("<option value='Damro' > Damro</option>");
            out.println("<option value='PepperFry'> PepperFry </option>");
            out.println("<option value='UrbanLadder'> UrbanLadder </option>");
             out.println("<option value='HomeAdore'> HomeAdore </option>");
              out.println("<option value='Grofer'> Grofer</option>");
               out.println("<option value='FreedomTree'> FreedomTree </option>");
            out.println("</select>");
            ...
            out.println("<div class='form-group'>");
            out.println("<br><input style='height:40px;font-size:17px;' type='text' name='budget' class='form-control' placeholder='Enter Your Approximated Budget' id='budget'>");
            ...
            out.println("<br><input style='height:40px;font-size:17px;' type='text' name='area' class='form-control' placeholder='Enter Your House Area In Sq.ft' id='area'>");
