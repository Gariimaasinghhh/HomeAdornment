...
out.println("<body style='background-image:url(https://lordnking.com/wp-content/uploads/2022/03/why-interior-design-and-architecture-matters-for-business.jpeg)'>");
   out.println("<br>");
       ...
       out.println("<h1 class='heading' style='margin-left:70px;'>FEEDBACK</h1>");
...
out.println("<form method='post' action='feedbackConf' >");
             ...
             out.println("<input type='name' name='name'  id='name' placeholder='Enter Your Name' id='name' style='height:35px;font-size:16pt;margin-left:290px;width:53%' >");
            out.println("<br>");
             out.println("<br><input type='email' name='email'  id='email' placeholder='Enter Your Email' id='email' style='height:35px;font-size:16pt;margin-left:290px;width:53%' >");
            out.println("<br>");
            out.println("<br><input type='text' name='feedback'  placeholder='Give Your Feedback Here' style='height:35px;font-size:16pt;margin-left:290px;width:53%' >");
             out.println("<br>");
