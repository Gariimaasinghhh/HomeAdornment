...
public class VIEW_REQUEST extends HttpServlet {
...
out.println("<body style='background-image:url(https://lordnking.com/wp-content/uploads/2022/03/why-interior-design-and-architecture-matters-for-business.jpeg)'>");
   out.println("<br>");
       ...
       out.println("<h1 class='heading' style='margin-left:70px;'>SEND CATALOUGES TO!</h1>");
            ...
            db.rst = db.stmt.executeQuery("select * from catalouge");
            int count = 1;
