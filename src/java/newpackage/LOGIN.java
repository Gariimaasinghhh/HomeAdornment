...
out.println("<br><br>");
out.println("<h1 class='heading' style='margin-left:70px;'>SIGN IN!</h1>");

out.println("<section class='home container-fluid p-0'>");
out.println("<div class='row hero'>");
 out.println(" <div >");
  out.println("<h1><br> <form style='font-size:19px;margin-left:460px;background-color:black;opacity:0.8;' action='loginConf' method='post' class='inputBox container px-4 py-3' onsubmit='return validate()'>");
            ...
            out.println("<select style='height:40px;font-size:17px;' name='type' class='form-control' id='type'>");
            out.println("<option selected disabled selected> Select any one </option>");
       ...
       out.println("</select>");
            ...
            out.println("<div class='form-group'>");
             out.println("<br><input  style='height:40px;font-size:17px;' type='text' class='form-control' required name='email' placeholder='Enter email' id='email'>");
           
             out.println("<br><input style='height:40px;font-size:17px;' type='password' required name='password' class='form-control' placeholder='Enter password' id='password'>");
           out.println("<br><input type='submit' class='btn btn-lg shadow-lg' style='color:black;font-weight:bold;height:40px;font-size:17px;background-color:#FF8D29;opaciy:1 !important;'>");
